 ...
 * @covers ClassyLlama\AvaTax\BaseProvider\Block\Adminhtml\Queue\ClearButton
...
class ClearButtonTest extends TestCase
{
    /**
     * Setup
     * @covers ClassyLlama\AvaTax\BaseProvider\Test\Unit\Block\Adminhtml\Queue\ClearButton
     * {@inheritDoc}
     */
    protected function setUp(): void
    {
        ...
        $this->block = $this->objectManager->getObject(
            \ClassyLlama\AvaTax\BaseProvider\Block\Adminhtml\Queue\ClearButton::class,
            [
     ...
     * tests button data
     * @test
     * @covers \ClassyLlama\AvaTax\BaseProvider\Block\Adminhtml\Queue\ClearButton::getButtonData
     */
    public function testGetButtonData()
    {
        $url = "";
        $message = __(
            'This will clear any queue that are older than the lifetime set in configuration. ' .
     ...
     * tests button url
     * @test
     * @covers \ClassyLlama\AvaTax\BaseProvider\Block\Adminhtml\Queue\ClearButton::getButtonUrl
     */
