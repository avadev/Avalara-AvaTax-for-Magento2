...
class SetupUtil
{
    ...
    const AVATAX_CA_COUNTY_RATE_JURISCODE = 'AVATAX-073';
    ...
    const AVATAX_CA_SAN_DIEGO_SPECIAL_RATE_TWO_DESCRIPTION = 'CA SPECIAL TAX';
    const AVATAX_CA_SAN_DIEGO_SPECIAL_RATE_TWO_JURISCODE = 'AVATAX-EMTU0';
    /**#@-*/
