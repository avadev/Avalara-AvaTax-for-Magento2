...
/**
 * Class AfterSaveObserverAvaTaxCustomerDoesNotExistExceptionTest
 * @covers \ClassyLlama\AvaTax\Observer\Model\Customer\AfterSaveObserver
 * @package ClassyLlama\AvaTax\Observer\Model\Customer
 */
class AfterSaveObserverAvaTaxCustomerDoesNotExistExceptionTest extends TestCase
{
    /**
    ...
    public function setUp(): void
    {
        ...
        $this->customerHelper = $this->getMockBuilder(\ClassyLlama\AvaTax\Helper\Customer::class)->disableOriginalConstructor()
                    ->getMock();
        $e = $this->objectManager->getObject(\ClassyLlama\AvaTax\Exception\AvaTaxCustomerDoesNotExistException::class);
        $this->customerHelper
            ->expects($this->any())
