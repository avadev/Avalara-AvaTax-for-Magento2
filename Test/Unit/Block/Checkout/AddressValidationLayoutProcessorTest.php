 ...
 */
class AddressValidationLayoutProcessorTest extends TestCase
{
    /**
     * Mock config
     *
    ...
    {
        $jsLayout = [];
        $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['tax']['config']['title'] = "Tax";
