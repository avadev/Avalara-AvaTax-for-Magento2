...
/**
 * @covers \ClassyLlama\AvaTax\Framework\Interaction\MetaData\IntegerType
 */
class IntegerTypeTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \ClassyLlama\AvaTax\Framework\Interaction\MetaData\IntegerType
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        \ClassyLlama\AvaTax\Framework\Interaction\MetaData\IntegerType::class,
            [
                'name' => '',
                'data' => $this->data,
            ]
     ...
     */
    public function testSetLength(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     */
    public function testSetOptions(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     */
    public function testSetSubtype(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
