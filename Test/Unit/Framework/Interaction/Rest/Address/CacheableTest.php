<?php
namespace ClassyLlama\AvaTax\Test\Unit\Framework\Interaction\Rest\Address;
...
/**
 * @covers \ClassyLlama\AvaTax\Framework\Interaction\Rest\Address\Cacheable
 */
class CacheableTest extends TestCase
{
    ...
    /**
     * Mock interactionAddress
     *
     * @var \ClassyLlama\AvaTax\Api\RestAddressInterface|PHPUnit\Framework\MockObject\MockObject
     */
     ...
     * Object to test
     *
     * @var \ClassyLlama\AvaTax\Framework\Interaction\Rest\Address\Cacheable
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        $this->phpSerialize = $this->createMock(\Magento\Framework\Serialize\Serializer\Json::class);
        ...
        $this->interactionAddress = $this->createMock(\ClassyLlama\AvaTax\Api\RestAddressInterface::class);
        ...
        \ClassyLlama\AvaTax\Framework\Interaction\Rest\Address\Cacheable::class,
            [
