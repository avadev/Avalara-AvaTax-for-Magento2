...
/**
 * @covers \ClassyLlama\AvaTax\Framework\Interaction\Rest\Tax\Result
 */
class ResultTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \ClassyLlama\AvaTax\Framework\Interaction\Rest\Tax\Result
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        //$this->data = $this->createMock(\array::class);
        $this->data = [];
     ...
     * @return array
     */
    public function dataProviderForTestGetTaxLine()
    {
        return [
            'Testcase 1' => [
    ...
    /**
     * @dataProvider dataProviderForTestGetTaxLine
     */
    public function testGetTaxLine(array $prerequisites, array $expectedResult)
    {
     ...
     * @return array
     */
    public function dataProviderForTestGetLineRate()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetLineRate
     */
    public function testGetLineRate(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
