...
namespace ClassyLlama\AvaTax\BaseProvider\Test\Unit\Framework\Rest;
 ...
 * @package ClassyLlama\AvaTax\BaseProvider\Framework
 */
class ApiClientTest extends TestCase
{
    ...
    public function testWithSecurity()
    {
        $username = '12345678';
        $pass1 = 'xxxxxxxxxxxx';
        $this->assertIsObject($this->apiClient->withSecurity($username, $pass1));
    }
