...
1. Require the desired version of AvaTax. Latest version can be installed by running following command:
   ...
   ```
   composer require avalara/avatax-magento:2.2.3
   ```
...
- Website owner does not able to upgrade to the newer version of extension due to MySQL DDL errors. Please, review [approach](./issues/AVASUP-934/approach.md)
