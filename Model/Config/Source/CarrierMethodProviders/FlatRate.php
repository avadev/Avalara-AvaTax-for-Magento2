...
class FlatRate implements \ClassyLlama\AvaTax\Api\CarrierShippingMethodsInterface
{
    /**
    ...
    /**
     * @param \Magento\OfflineShipping\Model\Carrier\Flatrate $carrier
     */
    public function __construct(\Magento\OfflineShipping\Model\Carrier\Flatrate $carrier)
    {
